<template>
    <div class="table">
        ...
        <div class="handle-box">
            ...
            <el-select v-model="select_cate" placeholder="房间类型" class="handle-select mr10">
                <el-option key="0" label="全部" value="全部"></el-option>
                <el-option key="1" label="日租房" value="日租房"></el-option>
                <el-option key="2" label="月租房" value="月租房"></el-option>
            </el-select>
        ...
        <el-table :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="date" label="房号" sortable width="150">
            </el-table-column>
